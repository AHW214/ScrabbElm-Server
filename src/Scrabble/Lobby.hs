...
removeRoom Room {roomName} lobby@Lobby {lobbyRooms} =
  lobby
    { lobbyRooms =
...
updateRoomView roomView@RoomView {roomViewName} lobby@Lobby {lobbyRooms} =
  lobby
    { lobbyRooms =
...
addRoom roomQueue room lobby@Lobby {lobbyRooms} =
  lobby
    { lobbyRooms =
...
removeClient Client {clientId} lobby@Lobby {lobbyClients} =
  lobby
    { lobbyClients =
...
addClient client@Client {clientId} lobby@Lobby {lobbyClients} =
  lobby
    { lobbyClients =
